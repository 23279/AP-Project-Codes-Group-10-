% =========================================================================
% MATLAB ANIMATION EXPORTER: MODERNA IMMUNE DYNAMICS (MP4 GENERATOR)
% =========================================================================
% Configuration: Secondary booster pulse configured for Day 28.
% Visuals: Muted, duller color panels for improved line visibility.
% =========================================================================

% Force close stuck figures and clear workspace safely
close all force; 
clear; clc;
...
% =========================================================================
% VIDEO WRITER INITIALIZATION WITH TRY/CATCH PROTECTION
% =========================================================================
...
try
    ...
    set(ax, 'Layer', 'top'); % Ensures grid lines stay clean over background elements
